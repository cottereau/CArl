function [stiffness,force,mass]=...
    StiffnessMassTimoshenkoBeamVar(GDof,numberElements,...
...
for e=1:numberElements
    ...
    for q=1:size(gaussWeights,1) ;
        ...
        stiffness(elementDof,elementDof)=...
            stiffness(elementDof,elementDof)+...
            B'*B*gaussWeights(q)*detJacobian*C(1,1,e);
% modifying original file for varying properties
%            B'*B*gaussWeights(q)*detJacobian*C(1,1);
        force(indice)=force(indice)+...
            shape*P(e)*detJacobian*gaussWeights(q);
% modifying original file for varying properties
...
for e=1:numberElements
    ...
    for q=1:size(gaussWeights,1) ;
        ...
        stiffness(elementDof,elementDof)=...
            stiffness(elementDof,elementDof)+...
            B'*B*gaussWeights(q)*detJacobian*C(2,2,e);
% modifying original file for varying properties
