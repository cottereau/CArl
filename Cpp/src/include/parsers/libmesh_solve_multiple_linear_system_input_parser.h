...
#ifndef LIBMESH_SOLVE_MULTIPLE_LINEAR_SYSTEM_INPUT_PARSER_H_
#define LIBMESH_SOLVE_MULTIPLE_LINEAR_SYSTEM_INPUT_PARSER_H_
...
struct libmesh_solve_multiple_linear_system_input_params {
  ...
  int number_begin;///< Number to begin the count
  int number_end;///<Number to end the count
 ...
 *    - `NumBegin` : number to begin the count 
 *    - `NumEnd` : number to end the count
 *    - `SysRHSVector` : path to the system RHS vector file. (number positions are replaced by *(Only 1))
 *    - `OutputBase` : output filename base. (number positions are replaced by *(Only 1))
 *
 *  Optional parameters:
...
#endif /* LIBMESH_SOLVE_MULTIPLE_LINEAR_SYSTEM_INPUT_PARSER_H_ */
/* Local Variables:                                                        */
/* mode: c                                                                 */
