...
/** \brief Program used to initialize the dynamic system for a homogeneous model with a clamped \f$x_{\mbox{Min}}\f$ face.
 * 
 *  Usage: `./libmesh_init_dyn_lin_homogeneous__min_x_clamped -i [input file]`
 *  
...
int main(int argc, char** argv) {
  ...
  // [USER] Fixed boudary
  //boundary_id_cube fixed_bound_id = boundary_id_cube::MIN_Z;
...
// Check libMesh installation dimension
  ...
  // Set clamped border
  //set_clamped_border(dynamic_system, fixed_bound_id); 

  // Give the system a pointer to the matrix assembly
  // function and the initial condition function defined
  // below.
  //t_system.attach_assemble_function  (assemble_dynamic);
  dynamic_system.attach_init_function      (apply_initial);
