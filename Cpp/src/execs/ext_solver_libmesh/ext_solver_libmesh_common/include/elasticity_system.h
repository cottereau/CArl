...
static const boundary_id_type & traction_boundary_id = boundary_id_max_z;
...
public:
  ...
  FEType get_fe_type(){return _fe_type;}
  ...
  Real getYoungModulus();
  void setYoungModulus(Real young_modulus);
