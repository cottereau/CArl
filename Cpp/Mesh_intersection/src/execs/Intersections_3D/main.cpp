...
int main(int argc, char *argv[])
{
	// Declare meshes
	// -> BIG mesh
	std::string filenameA = "meshes/3D/test_inter_A_3D.mesh";
	// -> small mesh
	std::string filenameB = "meshes/3D/test_inter_B_3D.mesh";

	std::string filenameOutput = "meshes/3D/output/test_inter_I_3D.mesh";
