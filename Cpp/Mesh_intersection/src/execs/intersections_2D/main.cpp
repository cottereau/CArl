...
int main(int argc, char *argv[])
{
	...
	// Declare meshes
	std::string filenameA = "meshes/2D/test_inter_A_2D.mesh";
	std::string filenameB = "meshes/2D/test_inter_B_2D.mesh";
	std::string filenameOutput = "meshes/2D/output/test_inter_I_2D.mesh";
