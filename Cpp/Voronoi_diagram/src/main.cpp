...
//			++edge_global_index;
			...
			for(int jjj = 1; jjj < face_nb_of_vertices; ++jjj)
			{
				edges_points_list[edge_global_index - 1][0] = reduced_point_list[treated_vertices + face_vertices_index[aux_index + jjj]];
				edges_points_list[edge_global_index - 1][1] = reduced_point_list[treated_vertices + face_vertices_index[aux_index + jjj + 1]];
				++edge_global_index;
			}

			edges_points_list[edge_global_index - 1][0] = reduced_point_list[treated_vertices + face_vertices_index[aux_index + face_nb_of_vertices]];;
			edges_points_list[edge_global_index - 1][1] = reduced_point_list[treated_vertices + face_vertices_index[aux_index + 1]];
