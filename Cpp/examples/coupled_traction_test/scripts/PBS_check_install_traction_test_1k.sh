...
job_inter=`qsub ../examples/coupled_traction_test/scripts/PBS_FETI_test_inter_traction_test_1k.pbs`

# - Prepare the external solver
job_ext=`qsub ../examples/coupled_traction_test/scripts/PBS_FETI_test_assemble_ext_solver_traction_test_1k.pbs`
